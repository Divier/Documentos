...
public class NumberToWords {
    ...
    static private ScaleUnit[] SCALE_UNITS = new ScaleUnit[] {
            ...
            new ScaleUnit(9, "billón", "milliard"),
            new ScaleUnit(6, "millón", "millón"),
            new ScaleUnit(3, "miles", "miles"),
            new ScaleUnit(2, "cientos", "cientos"),
    ...
    static public class UnitProcessor extends AbstractProcessor {
        ...
        static private final String[] TOKENS = new String[] { "uno", "dos", "tres", "cuatro",
    ...
    static public class TensProcessor extends AbstractProcessor {
        ...
        static private final String[] TOKENS = new String[] { "veinti", "treinta", "cuarenta",
                "cincuenta", "sesenta", "setenta", "ochenta", "noventa" };

        static private final String UNION_SEPARATOR = " y ";
    ...
    static public class DefaultProcessor extends AbstractProcessor {
        ...
        static private String MINUS = "menos";
        static private String UNION_AND = "y";

        static private String ZERO_TOKEN = "cero";
