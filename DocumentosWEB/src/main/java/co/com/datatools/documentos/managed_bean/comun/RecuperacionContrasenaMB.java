...
/**
 * MangedBean encargado de gestionar la solicitud de un vinculo de recuperacion de contraseña
 * 
...
@ManagedBean
@SessionScoped
public class RecuperacionContrasenaMB extends AbstractDocumentosSuperMB {
    ...
    private static final String PAGINA_RESTABLECER_PW = "public/recuperacionPw.xhtml";
    ...
    public String enviarVinculo() {
        ...
        try {
            ...
            final ServletContext context = (ServletContext) FacesContext.getCurrentInstance().getExternalContext()
                    .getContext();
            infoVinculoRecuperacionDto.setAplicacion(context.getInitParameter(ConstantesDocumentos.ID_APLICACION));
            infoVinculoRecuperacionDto.setFlujoRecuperacionPw(PAGINA_RESTABLECER_PW);
    ...
    public void validarVinculo() {
        ...
        if (!vinculoValidado) {
            ...
            if (solicitudAbierta) {
                ...
                // La solicitud es completamente valida, no debe mostrar mensaje,muestra el formulario de cambio decontrase�a
            } else {
    ...
    public String recuperarContrasena() {
        ...
        try {
            if (!pwNuevo.equals(confirmacionPwNuevo)) {
                ...
                FacesContext fContext = getFacesContext().getCurrentInstance();
                fContext.getExternalContext().getFlash().setKeepMessages(true);
                fContext.addMessage(null, new FacesMessage(FacesMessage.SEVERITY_INFO, mensaje, null));
