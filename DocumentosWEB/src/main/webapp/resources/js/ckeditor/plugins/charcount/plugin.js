	...
	init:function(editor){
		...
		if (editor.config.maxLength != null || editor.config.maxWords != null) {
			if (editor.config.maxLength != null)
				labelCounter = editor.lang.charcount.labelCharcount ? editor.lang.charcount.labelCharcount : 'Character counter';
			else
				labelCounter = editor.lang.charcount.labelWordcount ? editor.lang.charcount.labelWordcount : 'Word counter';
